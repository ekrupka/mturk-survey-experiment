	...
	photos: [
		{
			images: [
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/BillClinton.jpg',
				...
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/RonaldReagan.jpg',
		...
		},
		{
			images: [
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/MitchMcConnell.jpg',
				...
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/HarryReid.jpg',
		...
		},
		{
			images: [
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/JanBrewer.jpg',
				...
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/KathleenSebelius.jpg',
		...
		},
		{
			images: [
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/MicheleBachmann.jpg',
				...
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/NancyPelosi.jpg',
		...
		},
		{
			images: [
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/JoeBiden.jpg',
					alt: 'Joe Biden photo',
					id: 'joe-biden',
					label: 'Joe Biden',
				...
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/DickCheney.jpg',
	...
	photos: [
		{
			images: [
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/VotingLine1.jpg',
				...
				{
					src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/VotingLine2.jpg',
					alt: 'Voting Line Photo',
					id: 'voting-line-2',
					label: 'I think this voting line is longest',
					name: 'voting-line',
...
var contextStates = {
	...
	states: [
		{
			src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/NorthCarolina.png',
			alt: 'North Carolina photo',
			name: 'north-carolina',
			state: 'North Carolina'
		},
		{
			src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/Georgia.png',
			alt: 'Georgia photo',
			name: 'georgia',
			state: 'Georgia'
		},
		{
			src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/Florida.png',
			alt: 'Florida photo',
			name: 'florida',
			state: 'Florida'
		},
		{
			src: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/images/Ohio.png',
			alt: 'Ohio photo',
			name: 'ohio',
			state: 'Ohio'
		}
...
!function($) {
	function NextQuestion( $elt ) {
		...
		this.templateNames = [
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/templates/intro.html',
				dataName: 'intro'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/templates/question.html',
				dataName: 'question'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/templates/two-question.html',
				dataName: 'twoPic'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/templates/one-pic.html',
				dataName: 'onePic'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/templates/one-pic-radio-opts.html',
				dataName: 'onePicInput'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/templates/tokens.html',
				dataName: 'tokenBase'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/treat_norms_framed_random/templates/survey.html',
				dataName: 'survey'
			}
		];
