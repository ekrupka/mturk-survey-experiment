...
!function($) {
	function NextQuestion( $elt ) {
		...
		this.templateNames = [
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/base_norms_conditional/templates/intro.html',
				dataName: 'intro'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/base_norms_conditional/templates/question-header.html',
				dataName: 'question'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/base_norms_conditional/templates/two-question.html',
				dataName: 'twoPic'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/base_norms_conditional/templates/one-pic.html',
				dataName: 'onePic'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/base_norms_conditional/templates/tokens.html',
				dataName: 'tokenBase'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/base_norms_conditional/templates/survey.html',
				dataName: 'survey'
			}
		];
