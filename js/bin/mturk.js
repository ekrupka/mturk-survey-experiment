...
var contextExplain = {
	...
	descAll: [
		...
		[
			'A group of MTurkers, who are all <span class="pol-class"></span>s, rated worker A\'s wealth redistribution decisions based on how socially appropriate they thought each decision was.',
...
var contextTokenIntro = {
	...
	desc: [
		...
		'Your task is to rate worker A\'s wealth redistribution decision based on your guess of whether most <span class="pol-class"></span>s would think the decision was "socially appropriate" and "consistent with what most <span class="pol-class"></span>s would think worker A OUGHT to do".',
		'Remember that you will only earn the bonus if your "social appropriateness" rating is that same as what most <span class="pol-class"></span>s rated.  For each rating that is the same, you will earn 10 cents.',
	]
}
...
!function($) {
	function NextQuestion( $elt ) {
		...
		this.templateNames = [
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/NEP_treat_cross_ID/templates/intro.html',
				dataName: 'intro'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/NEP_treat_cross_ID/templates/question.html',
				dataName: 'question'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/NEP_treat_cross_ID/templates/two-question.html',
				dataName: 'twoPic'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/NEP_treat_cross_ID/templates/one-pic.html',
				dataName: 'onePic'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/NEP_treat_cross_ID/templates/one-pic-radio-opts.html',
				dataName: 'onePicInput'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/NEP_treat_cross_ID/templates/tokens.html',
				dataName: 'tokenBase'
			},
			{
				url: 'https://rawgit.com/ekrupka/mturk-survey-experiment/NEP_treat_cross_ID/templates/survey.html',
				dataName: 'survey'
			}
		];
